...
*图 3：此处“Elo-matched”指评分差不超过 200。图中展示至少 15 场的分组，省略的对局仍计入总体。“Mirror”包含所有蜜集大蛇牌表。每行上方的灰色线段为近似 Wilson 95% 区间；重复遇到同一对手可能使区间偏乐观。*

在这一分组中，面对完全相同的牌表，我取得了 **74 场 53 胜，即 71.6% [60.5%–80.6%]**。双方卡牌相同，这些对局更能反映策略如何使用卡组，不过对手水平仍有差异。

面对多龙巴鲁托的 Jamming Tower 构筑，我的胜率为 55.4%，对 Risky Ruins 构筑则为 42.9%。对胡地的 138 场，我的胜率为 45.7%。这两个流派的实战胜率都低于训练时的表现；两种评估使用的对手和牌表有所不同。
